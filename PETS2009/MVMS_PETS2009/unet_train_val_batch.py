...
from net_def_unet_v3 import build_model_UNet_model_api as build_UNet
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-e", "--exp_name",
        type=str,
        default='models/unet/PETS_output_'+time_str,
        action="store")
    parser.add_argument(
        "-v", "--verbosity",
        type=int,
