...
class SpatialTransformer(Layer):
    ...
    def _transform(self, view, input_shape, output_size):
        ...
        num_channels = input_shape.shape[3]
        ...
        if (view == 1):
            view1_ic = np.load(
                'coords_correspondence_Street/projection_forth/view1_correspondence_forth_fullHeight.npz')
            ...
            view1_gp_mask = cv2.resize(view1_gp_mask, (int(640 / 4), int(768 / 4)))
            ...
            view_norm_mask = np.load('coords_correspondence_Street/norm/view_Wld_normalization_forth_mask.npz')
            ...
            view2_ic = np.load(
                'coords_correspondence_Street/projection_forth/view2_correspondence_forth_fullHeight.npz')
            ...
            view2_gp_mask = cv2.resize(view2_gp_mask, (int(640 / 4), int(768 / 4)))
            ...
            view3_ic = np.load(
                'coords_correspondence_Street/projection_forth/view3_correspondence_forth_fullHeight.npz')
            ...
            view3_gp_mask = view3_gp_mask.arr_0
            view3_gp_mask = cv2.resize(view3_gp_mask, (int(640 / 4), int(768 / 4)))
