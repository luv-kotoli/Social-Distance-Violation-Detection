...
def unet_upsample_block4(base_weight_decay,x,concat):
    ...
    concat = Cropping2D(cropping=((0,1),(0,1)))(concat)
...
def unet_upsample_block5(base_weight_decay,x,concat):
    ...
    concat = Cropping2D(cropping=((1,1),(1,1)))(concat)
...
def build_model_UNet_model_api(batch_size,
    ...
    # project scale 1
    proj1_1 = SpatialTransformer(1,[710,610],scale=1)(conv1_1)
    proj1_2 = SpatialTransformer(2,[710,610],scale=1)(conv1_2)
    proj1_3 = SpatialTransformer(3,[710,610],scale=1)(conv1_3)
    ...
    # project scale 2
    proj2_1 = SpatialTransformer(1,[710//2, 610//2],scale=2)(conv2_1)
    proj2_2 = SpatialTransformer(2,[710//2, 610//2],scale=2)(conv2_2)
    proj2_3 = SpatialTransformer(3,[710//2, 610//2],scale=2)(conv2_3)
    ...
    # project scale 2
    proj3_1 = SpatialTransformer(1,[710//4, 610//4],scale=3)(conv3_1)
    proj3_2 = SpatialTransformer(2,[710//4, 610//4],scale=3)(conv3_2)
    proj3_3 = SpatialTransformer(3,[710//4, 610//4],scale=3)(conv3_3)
