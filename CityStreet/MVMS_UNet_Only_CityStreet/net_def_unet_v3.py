...
def build_model_UNet_model_api(batch_size,
    ...
    # project
    proj_v1 = SpatialTransformer(1, [768, 640],scale=1)(unet_v1)
    proj_v2 = SpatialTransformer(2, [768, 640],scale=1)(unet_v2)
    proj_v3 = SpatialTransformer(3, [768, 640],scale=1)(unet_v3)
