...
class SpatialTransformer_2DTo2D_real(Layer):
    ...
    def call(self, inputs, mask=None):
        ...
        view_i = view
        self.proj_2DTo2D(view_i, inputs[0:1, ...])
    ...
    def proj_2DTo2D(self, view, inputs):
        ...
        if view== 'view1':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view1_new_1.npz')
        if view== 'view2':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view2_new_1.npz')
        if view== 'view3':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view3_new_1.npz')
