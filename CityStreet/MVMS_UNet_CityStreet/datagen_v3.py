...
def datagen_v3(h5file_view1, h5file_view2, h5file_view3, h5file_GP,
    ...
    while 1:
        ...
        if nb_patch_used + batch_size < patches_per_set + 1: #or (ind_image == 0 and nb_patch_used == 0):
            ...
            img2_s0 = images2[n, :, :, :]
            img2_s1 = cv2.resize(img2_s0, (int(img2_s0.shape[1]/2), int(img2_s0.shape[0]/2)))
            img2_s2 = cv2.resize(img2_s1, (int(img2_s1.shape[1]/2), int(img2_s1.shape[0]/2)))
            ...
            #img2_s0 = np.tile(img2_s0, (1, 1, 1, 3))
            #img2_s1 = np.tile(img2_s1, (1, 1, 1, 3))
            #img2_s2 = np.tile(img2_s2, (1, 1, 1, 3))
            ...
            img3_s0 = images3[n, :, :, :]
            img3_s1 = cv2.resize(img3_s0, (int(img3_s0.shape[1]/2), int(img3_s0.shape[0]/2)))
            img3_s2 = cv2.resize(img3_s1, (int(img3_s1.shape[1]/2), int(img3_s1.shape[0]/2)))
            ...
            #img3_s0 = np.tile(img3_s0, (1, 1, 1, 3))
            #img3_s1 = np.tile(img3_s1, (1, 1, 1, 3))
            #img3_s2 = np.tile(img3_s2, (1, 1, 1, 3))
