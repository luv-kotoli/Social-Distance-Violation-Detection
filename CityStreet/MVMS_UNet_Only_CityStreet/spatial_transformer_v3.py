...
class SpatialTransformer_2DTo2D_real(Layer):
    ...
    def proj_2DTo2D(self, view, inputs,scale):
        ...
        if view== 'view1':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view1_new_{}.npz'.format(scale))
        if view== 'view2':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view2_new_{}.npz'.format(scale))
        if view== 'view3':
            view_ic = np.load('coords_correspondence_Street/projection_forth/view3_new_{}.npz'.format(scale))
