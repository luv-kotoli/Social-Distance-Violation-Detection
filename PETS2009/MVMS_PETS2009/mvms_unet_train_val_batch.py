...
from datagen_mvms_unet import datagen_v3

from net_def_mvms_unet import build_model_FCN_model_api as build_FCNN
...
def main(exp_name='FCNN', verbosity=0):
    ...
    if os.path.isdir(save_dir)==True:
        model.load_weights(filepath=os.path.join(save_dir, 'best.h5'), by_name=True)
    ...
    train_view1_1 = train_path0 + 'train/view1.h5'
    train_view2_1 = train_path0 + 'train/view2.h5'
    train_view3_1 = train_path0 + 'train/view3.h5'
    train_GP_1 = train_path0 + 'train/gp_violations.h5'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-e", "--exp_name",
        type=str,
        default='models/mvms_unet/PETS_output_'+time_str,
        action="store")
    parser.add_argument(
        "-v", "--verbosity",
        type=int,
